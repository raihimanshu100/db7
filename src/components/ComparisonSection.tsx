            ...
            <table className="w-full min-w-[340px]">
              <thead>
                <tr className="border-b border-primary/10">
                  <th className="text-left p-2.5 sm:p-5 text-[11px] sm:text-sm font-display font-semibold text-text-secondary w-[28%]">
                    Feature
                  </th>
                  <th className="text-left p-2.5 sm:p-5 text-[11px] sm:text-sm font-display font-semibold w-[36%]"
                    style={{ color: '#6b7280', background: 'rgba(30,32,40,0.6)' }}>
                    Traditional Banking
                  </th>
                  <th className="text-left p-2.5 sm:p-5 text-[11px] sm:text-sm font-display font-bold w-[36%]"
              ...
              <tbody>
                {rows.map((row, i) => (
                  ...
                  >
                    <td className="p-2.5 sm:p-5 text-[11px] sm:text-sm font-display font-semibold text-foreground">{row.feature}</td>
                    <td className="p-2.5 sm:p-5 text-[11px] sm:text-sm font-display" style={{ background: 'rgba(20,22,30,0.3)' }}>
                      <span className="flex items-start gap-1 sm:gap-2 text-gray-500">
                        <XCircle size={12} className="text-red-500/70 shrink-0 mt-0.5 sm:w-[14px] sm:h-[14px]" />
                        {row.trad}
                      </span>
                    </td>
                    <td className="p-2.5 sm:p-5 text-[11px] sm:text-sm font-display"
                      ...
                      <span className="flex items-start gap-1 sm:gap-2 text-white font-medium">
                        <CheckCircle2 size={12} className="text-primary shrink-0 mt-0.5 sm:w-[14px] sm:h-[14px]" />
                        {row.db7}
                      </span>
                    </td>
                  </motion.tr>
